...
class SliderCarousel {
  ...
  addStyle() {
    let style = document.getElementById('slyderCarousel-style');
    if (!style) {
      style = document.createElement('style');
      style.id = 'slyderCarousel-style';
    }
    ...
    style.textContent = `
        ...
        .glo-slider__wrap{
          ...
          will-change: transofm !important;
        }
        .glo-slider__item{
          display: flex !important;
          align-items: center;
  ...
  responseInit() {
    ...
    const checkResponse = () => {
      const widthWindow = document.documentElement.clientWidth;//получение ширины экрана без скролов
